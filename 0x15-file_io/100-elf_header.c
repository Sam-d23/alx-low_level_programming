 ...
 * Description: In case the file is not an ELF file - exit code 98.
 */
void check_elf(unsigned char *e_ident)
{
	int i;
 ...
 * @e_ident: pointer to an array of the ELF magic numbers.
 * Description: separetes magic numbers by spaces.
 */
void print_magic(unsigned char *e_ident)
{
	int j;
...
/**
 * print_type - funtion to print the type of an ELF header.
 * @e_type: indicates ELF type.
 * @e_ident: pointer to an array of the ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
 ...
 * Description: In case the file cannot be closed - exit code 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
 ...
 * Return: 0 (Success)
 * Description: in case the file is not an ELF File or if
